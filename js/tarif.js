...
var tarifs = document.getElementById("main_tarif");
// var Equipement = document.querySelector(".intro_equipement");
var content = document.getElementsByTagName("body")[0];
var darkMode = document.getElementById("dark-change");
var Forfaits = document.getElementById("NosForfaits");

darkMode.addEventListener("click", function () {
  darkMode.classList.toggle("active");
  content.classList.toggle("night");
  tarifs.style.background = "#1b1c24";
  Forfaits.style.color = "white";
});
