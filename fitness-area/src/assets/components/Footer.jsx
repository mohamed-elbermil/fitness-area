    ...
    <footer className="footer">
      ...
      <div className="footer-header">
        ...
        <div className="social-icons">
          ...
          <a href="https://www.instagram.com/fitnessarea8/" target="blank" className="social-icon" aria-label="Instagram">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <div className="footer-main">
        <nav className="footer-nav" aria-label="Navigation principale du footer">
          <ul>
            <li><a href="#">Club</a></li>
        ...
        <div className="footer-contact">
          <a href="tel:+04XX683216">04.XX.68.32.16</a>
          <a href="mailto:Contact@fitness-area.fr">Contact@fitness-area.fr</a>
          <p>Ouverture du Lundi au Dimanche de 6h00 à 23h00</p>
        </div>
        ...
        <div className="footer-newsletter">
          ...
          <form className="newsletter-form" onSubmit={e => e.preventDefault()}>
            ...
            <button type="submit" className="subscribe-btn">JE M'INSCRIS</button>
          </form>
        </div>
      </div>
